...
@endsection
@section('title')
    <title>KoperasiPG | Memo Penutup</title>
@endsection
@section('content')
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 mt-3">
                        <a href="{{ route('admin.mp.create') }}" class="btn btn-primary mb-3">Tambah Data</a>
                        <a href="#" data-toggle="modal" data-target="#mauimport" class="btn btn-success mb-3 ml-3">Import File</a>
                        <div class="card">
                            <div class="card-header">
                                <div class="card-tools">
                                    <form action="{{ route('admin.mp.index') }}" method="GET">
                                    ...
                                    <tbody>
                                        @foreach ($data as $d)
                                            <tr>
                                                ...
                                                <td>{{ $d->email }}</td>
                                                <td>
                                                    <a href="{{ route('admin.mp.detail', ['id' => $d->id]) }}"
                                                        class="btn btn-info"><i class="fas fa-eye"></i> Detail</a>
                                                    <a href="{{ route('admin.mp.edit', ['id' => $d->id]) }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Apakah kamu yakin ingin menghapus data memo penutup
                                                                <b>{{ $d->name }}</b>
                                                            </p>
                                                        </div>
                                                        <div class="modal-footer justify-content-between">
                                                            <form
                                                                action="{{ route('admin.mp.delete', ['id' => $d->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
    ...
    @include('admin.dataharian.memopenutup.import')
@endsection