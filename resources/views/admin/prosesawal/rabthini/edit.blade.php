    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ route('admin.rti.update', ['id' => $data->id]) }}" method="POST"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="tahun"
                                                name="tahun" value="{{ $data->tahun }}" min="1900" max="2099" required>
                                            @error('tahun')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="nomor_perkiraan"
                                                name="nomor_perkiraan" onchange="setnoper()"> 
                                                @foreach ( $noper as $n )
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_perkiraan" class="form-control"
                                                id="exampleInputEmail1" value="{{ $data->nama_perkiraan }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="rab_januari" class="form-control"
                                                id="exampleInputEmail1" value="{{ $data->rab_januari }}">
                                            @error('rab_januari')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rab_februari" class="form-control"
                                                id="exampleInputEmail1" value="{{ $data->rab_februari }}">
                                            @error('rab_februari')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rab_maret" class="form-control"
                                                id="exampleInputEmail1" value="{{ $data->rab_maret }}">
                                            @error('rab_maret')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rab_april" class="form-control"
                                                id="exampleInputEmail1" value="{{ $data->rab_april }}">
                                            @error('rab_april')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rab_mei" class="form-control"
                                                id="exampleInputEmail1" value="{{ $data->rab_mei }}">
                                            @error('rab_mei')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rab_juni" class="form-control"
                                                id="exampleInputEmail1" value="{{ $data->rab_juni }}">
                                            @error('rab_juni')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rab_juli" class="form-control"
                                                id="exampleInputEmail1" value="{{ $data->rab_juli }}">
                                            @error('rab_juli')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rab_agustus" class="form-control"
                                                id="exampleInputEmail1" value="{{ $data->rab_agustus }}">
                                            @error('rab_agustus')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rab_september" class="form-control"
                                                id="exampleInputEmail1" value="{{ $data->rab_september }}">
                                            @error('rab_september')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rab_oktober" class="form-control"
                                                id="exampleInputEmail1" value="{{ $data->rab_oktober }}">
                                            @error('rab_oktober')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rab_november" class="form-control"
                                                id="exampleInputEmail1" value="{{ $data->rab_november }}">
                                            @error('rab_november')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rab_desember" class="form-control"
                                                id="exampleInputEmail1" value="{{ $data->rab_desember }}">
                                            @error('rab_desember')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            <input type="hidden" name="created_by" class="form-control"
                                                id="exampleInputEmail1" value="{{ $data->created_by }}">
                                            @error('created_by')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
